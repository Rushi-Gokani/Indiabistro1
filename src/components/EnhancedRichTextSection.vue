...
// Max width mapping for different options
...
<template>
  ...
  >
    ...
    <div
      class="relative mx-auto flex w-full flex-col items-center gap-8 px-6 text-center md:px-10"
    ...
    >
      ...
      <!-- Heading -->
      <h2
        class="text-2xl font-normal uppercase tracking-[0.25em] md:text-3xl lg:text-4xl"
        :style="{ color: props.headingColor }"
      >
        {{ props.heading }}
      </h2>

      <!-- Description (Single paragraph or multiple paragraphs) -->
      <div v-if="props.description" class="space-y-4">
        <p
          class="text-sm leading-relaxed tracking-wide md:text-base lg:text-lg"
      ...
      <!-- Multiple Paragraphs -->
      <div v-else-if="props.paragraphs && props.paragraphs.length > 0" class="space-y-4">
        <p
